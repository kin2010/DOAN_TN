...
var trademark_service_1 = __importDefault(require("../services/trademark.service"));
var TrademarkController = /** @class */ (function () {
    function TrademarkController() {
    }
    var _a;
    _a = TrademarkController;
    TrademarkController.create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var responce, error_1;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, trademark_service_1.default.create(__assign({}, req.body))];
                case 1:
                    responce = _b.sent();
